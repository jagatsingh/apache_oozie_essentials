...
sudo -u hdfs hadoop fs -mkdir -p $hdfs_install_base
sudo -u hdfs hadoop fs -chown -R oozie:oozie $hdfs_install_base
...
# cp /media/sf_jagatsingh/GitBook/Library/jagatsingh/oozie/learn_oozie/ch09/target/*.zip .
